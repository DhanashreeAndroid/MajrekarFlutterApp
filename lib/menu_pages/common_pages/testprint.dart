   ...
   /* var response = await http.get(Uri.parse(
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        ...
        bluetooth.printCustom("HEADER", Size.boldMedium.val, PrinterAlign.center.val);
        bluetooth.printNewLine();
       ...
       //bluetooth.printImageBytes(imageBytesFromAsset); //image from Asset
        ...
        bluetooth.printNewLine();
        bluetooth.printCustom("čĆžŽšŠ-H-ščđ", Size.bold.val, PrinterAlign.center.val,
            charset: "windows-1250");
        bluetooth.printLeftRight("Številka:", "18000001", Size.bold.val,
            charset: "windows-1250");
        bluetooth.printCustom("Body left", Size.bold.val, PrinterAlign.left.val);
        bluetooth.printCustom("Body right", Size.medium.val, PrinterAlign.right.val);
        bluetooth.printNewLine();
        bluetooth.printCustom("Thank You", Size.bold.val, PrinterAlign.center.val);
        bluetooth.printNewLine();
        bluetooth.printQRcode(
            "Insert Your Own Text to Generate", 200, 200, PrinterAlign.center.val);
        bluetooth.printNewLine();
        bluetooth.printNewLine();
        bluetooth
